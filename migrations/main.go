...
func main() {
	flag.Usage = usage
	dbname := flag.String("dbname", "chiastat_db", "database name")
	flag.Parse()

	db := pg.Connect(&pg.Options{User: "chiastat", Password: "chia", Database: *dbname})
	db.AddQueryHook(dbLogger{})

	migrations.SetTableName("chiastat.gopg_migrations")
